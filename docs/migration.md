...
the [`CDKHydrogenAdder`](http://cdk.github.io/cdk/latest/docs/api/org/openscience/cdk/tools/CDKHydrogenAdder.html) as explained in Section ??.
...
**Script** [code/UniqueSMILES.py](code/UniqueSMILES.code.md)
```python
